...
namespace Adoroid.CarService.Application.Features.UserToCompanies.Queries.GetList.Validators;

public class GetListUserToCompanyQueryValidator : AbstractValidator<GetListUserToCompanyQuery>
{
    public GetListUserToCompanyQueryValidator()
    {
