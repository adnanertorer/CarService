...
namespace Adoroid.CarService.Application.Features.Customers.Commands.Create.Validators;

public class CreateCustomerCommandValidators : AbstractValidator<CreateCustomerCommand>
{
    public CreateCustomerCommandValidators()
    {
        RuleFor(x => x.Name)
            .NotEmpty()
